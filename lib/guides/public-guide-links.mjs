 ...
 * then non-Disney.
 * `coverTitle` is the catalog film whose poster represents the guide on the index.
 */
export const PUBLIC_GUIDE_LINKS = [
  ...
  },
  {
    ...
    coverTitle: "Fantastic Planet",
  },
  {
    slug: NON_DISNEY_ANIMATED_MOVIES_GUIDE.slug,
    href: `/guides/${NON_DISNEY_ANIMATED_MOVIES_GUIDE.slug}`,
    label: "Non-Disney animated movies",
    title: NON_DISNEY_ANIMATED_MOVIES_GUIDE.h1,
    description: NON_DISNEY_ANIMATED_MOVIES_GUIDE.intro[0],
    coverTitle: "The Painting",
  },
];
