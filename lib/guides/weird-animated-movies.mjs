  ...
  groups: [
    {
      ...
      description:
        "These films take place in worlds that are fundamentally unlike ours — a folkloric monster on the road, a future where people turn into trees, an epic of kings and sorcerers. Their strangeness comes from accepting impossible beings and unfamiliar rules as completely normal.",
      films: [
        { title: "Nobody" },
        { title: "White Plastic Sky" },
        { title: "The Last Fiction" },
      ],
    },
    {
      heading: "When the story runs on dream logic",
      description:
        "These films move by association, transformation, and sudden shifts rather than by a neat sequence of events. The Storm slips through ink, opera, and unstable identities, Dozens of Norths is deliberately fragmented, and The Tune turns a simple journey into a chain of surreal encounters.",
      films: [
        { title: "The Storm" },
    ...
    },
    {
      ...
      description:
        "These films begin with things we recognize — a hotel, a town, a city — and push them somewhere much stranger. Spaces transform, familiar stories turn grotesque, and ordinary places start following their own absurd or unsettling logic.",
      films: [
        { title: "Memory Hotel" },
