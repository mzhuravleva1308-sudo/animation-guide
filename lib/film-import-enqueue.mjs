...
export function buildFilmImportQueueRow(film, options = {}) {
  ...
  if (film.origin != null || options.origin != null) {
    row.origin = options.origin ?? film.origin;
  }
  if (film.discovery_candidate_id != null || options.discoveryCandidateId != null) {
    row.discovery_candidate_id =
      options.discoveryCandidateId ?? film.discovery_candidate_id;
  }
  if (options.resultChecklist != null) {
    row.result_checklist = options.resultChecklist;
  }
  return row;
}
