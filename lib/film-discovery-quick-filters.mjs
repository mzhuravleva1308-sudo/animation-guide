...
- Do NOT invent other tokens. Do NOT store stop-motion / recent / award-winners here (those are derived: stop-motion from technique, recent from year, award-winners from festival_recognitions).
...
export function buildDiscoveryCatalogFilterPills(film) {
  ...
  // Lazy import avoided — inline check to keep this module free of festival deps cycles.
