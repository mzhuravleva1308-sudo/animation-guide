...
export const CATALOG_MEDIA_TYPE_COLUMN = "media_type";
 ...
 */
export function applyPublicCatalogMediaTypeFilter(query, mediaType) {
  return query.eq(CATALOG_MEDIA_TYPE_COLUMN, mediaType);
}
